...
@Component({
      ...
      <div class="auth-card">
        ...
        <form (ngSubmit)="onRegister()" class="auth-form">
          ...
          <div class="form-group">
            ...
            <input type="text" id="username" [(ngModel)]="username" name="username" required placeholder="Nombre de usuario">
          </div>
          <div class="form-group">
            <label for="fullName">Nombre completo</label>
            <input type="text" id="fullName" [(ngModel)]="fullName" name="fullName" placeholder="Tu nombre completo">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="password" id="confirmPassword" [(ngModel)]="confirmPassword" name="confirmPassword" required placeholder="Repite tu contraseña">
          </div>
  ...
  styles: [`
    ...
    .success-message { color: #27ae60; font-size: 0.9rem; margin-bottom: 1rem; text-align: center; }
